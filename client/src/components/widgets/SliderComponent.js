            ...
            <Slider {...settings}>
                <div className={"main-content__slider__slide"}>
                    ...
                    <div className={"main-content__slider__div"}>
                        <p>Мы  компания, которая увезёт заброшенный автомобиль и тем самым освободит ваше парковочное место.</p>
                        <p>Сообщите нам, если вы заметили заброшенное авто, и мы увезём его.</p>
                    </div>
                </div>
                <div className={"main-content__slider__slide"}>
                    <h3 className={"main-content__slider__h3"}>
